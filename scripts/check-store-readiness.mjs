...
const launch=await read('src/launch.html'); if(!/017_rc2_offer_delivery_preferences\.sql/.test(launch)||!/backend unavailable/i.test(launch))fail('Launch checklist must describe the complete RC2 migration sequence and no-backend behavior'); else pass('Launch checklist reflects the current RC2 database and runtime gates');
